...
vignette: >
  %\VignetteIndexEntry{Measuring Emergence}
...
This article explains why measuring emergence is difficult and how the function `measure_emergence()` should be interpreted. Emergence is not a single quantity. It may involve order, complexity, novelty, organization, information, multi-level structure, or causal dependence [@holland1998emergence; @mitchell2009complexity].
...
Entropy is often used to describe diversity, uncertainty, or unpredictability in a distribution [@shannon1948mathematical; @cover2006elements].
